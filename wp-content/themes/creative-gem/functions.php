    ...
    function creative_gem_archive_post( $layout = '' ) { 
      ...
      <article class="post excerpt">
       ...
       <?php } ?>
        ...
        <h2 class="title">
          <a href="<?php the_permalink() ?>" style="text-transform: uppercase; color:#542189;text-decoration: underline;" title="<?php the_title_attribute(); ?>" rel="bookmark"><?php the_title(); ?></a>
        </h2>
